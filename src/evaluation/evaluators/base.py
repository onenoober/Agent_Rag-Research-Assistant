...
class BaseEvaluator(ABC):
    ...
    - Async Support: Supports both sync and async evaluate() for compatibility.
    """
    ...
    def evaluate(
        ...
        **kwargs: Any,
        ...
        This base implementation provides a default sync implementation.
        Subclasses may override with async implementations (like RagasEvaluator).
        ...
        raise NotImplementedError(
            ...
            "Override this method or use an async subclass."
        )
...
class NoneEvaluator(BaseEvaluator):
    ...
    This implementation is used when evaluation is disabled or when
    no retrieved chunks are available (e.g., --no-search mode).
    """
