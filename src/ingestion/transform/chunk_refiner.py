...
from src.core.settings import Settings, resolve_path, ConcurrencySettings, load_settings
...
def _get_default_max_workers() -> int:
    ...
    try:
        ...
        if settings.ingestion and settings.ingestion.concurrency:
            return settings.ingestion.concurrency.llm_transform
    except Exception:
        pass
    ...
    def __init__(
        ...
        Args:
            ...
            max_workers: Max parallel workers for LLM calls. 
                         If None, uses settings.ingestion.concurrency.llm_transform
        """
        ...
        if max_workers is not None:
            ...
            self._max_workers = settings.ingestion.concurrency.llm_transform
        else:
            ...
            refined_chunk = Chunk(
                ...
                metadata={
                    **(chunk.metadata or {}),
                    ...
                    'original_text': chunk.text,  # Preserve for potential retrieval or analysis
                },
