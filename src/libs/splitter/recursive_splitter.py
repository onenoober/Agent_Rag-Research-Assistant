...
class RecursiveSplitter(BaseSplitter):
    ...
    # Optimized separators for both Chinese and English
    # Order matters: try larger semantic units first, then smaller
    # Key: paragraphs > sentences > lines > words
    # Chinese: \n\n > 。！？； > \n > ，
    # English: \n\n > . ! ? ; > \n > ,
    DEFAULT_SEPARATORS = [
        "\n\n",  # Paragraphs (highest semantic coherence)
        "。",    # Chinese period
        "！",    # Chinese exclamation
        ...
        ";\n",   # English semicolon
        "\n",    # Single newline (lines) - lower priority than sentences
        "，",    # Chinese comma
        ", ",    # English comma + space
        " ",     # Space (words)
