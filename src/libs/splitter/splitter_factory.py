...
def _register_builtin_providers() -> None:
    ...
    try:
        from src.libs.splitter.structured_splitter import StructuredSplitter
        SplitterFactory.register_provider("structured", StructuredSplitter)
    except ImportError:
        pass  # StructuredSplitter not available

    try:
        from src.libs.splitter.smart_splitter import SmartSplitter
        SplitterFactory.register_provider("smart", SmartSplitter)
    except ImportError:
        pass  # SmartSplitter not available
    
    try:
        from src.libs.splitter.academic_splitter import AcademicPaperSplitter
        SplitterFactory.register_provider("academic", AcademicPaperSplitter)
    except ImportError:
        pass  # AcademicPaperSplitter not available
